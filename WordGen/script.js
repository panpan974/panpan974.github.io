...
document.querySelector("form").addEventListener("submit",function(event){
    ...
    else{console.log("Veuillez remplir tous les gens");
...
function VerficationChiffre(userInputPlace){
    ...
    console.log(userInputPlace.name);

    //Vérification du caractère Unicode de l'user
...
function getLetter(){
    ...
    do{
        ...
        c+=offset;
    }while(!isVowel&&vowels.includes(c)
...
function phono_balance(){
    ...
    c=getLetter();
    if(isVowel) vowelsInRow++;
    else consonantsInRow++;
