...
//Tableau qui va contenir toutes les coupes.
...
function VerifyCoupe(){
    switch(coupe){
        case 'none':
            ...
            console.log(document.getElementById('svgBouclier'));
            //On va supprimer le svg existant
            //document.getElementById('svgBouclier').remove();
            var newDiv=document.createElement("svg");
            //création du svg
...
function drop(ev) {
    ...
    switch(classeZone){
        case "color1":
            ...
            document.getElementById('Fcolor1').value=data;
