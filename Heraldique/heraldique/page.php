<?php
    ...
    $titre_principal="Mentions légales";
?>
...
<html>
    ...
    <body>
        ...
        <div>
            ...
            <p><?php echo "PUTAIN" ?> </p>
            <br>p<br>p<br>paaaaaaaa<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p<br>p
        </div>
